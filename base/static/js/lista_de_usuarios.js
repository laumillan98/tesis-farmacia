...
const listaDeUsuarios = async () => {
    try{  
        ...
        data.usuarios.forEach((usuario, index) => {
            ...
            ? "<button id='editar' class='btn btn-sm btn-secondary' data-action='editar'><i class='fa-solid fa-pencil'></i></button>&nbsp<button id='softdelete' class='btn btn-sm btn-danger' data-id='"+ usuario.username +"'><i class='fa-solid fa-trash-can'></i></button>"
            ...
            ? "<button id='editar' class='btn btn-sm btn-secondary' data-action='editar'><i class='fa-solid fa-pencil'></i></button>"
            : ""+ buttonContent2 +"";
